...
class agent():
    def __init__(self, lr, s_size,a_size,h_size):
        ...
        self.chosen_action = tf.argmax(self.output,1,name="max_output")
        ...
        self.update_batch = optimizer.apply_gradients(zip(self.gradient_holders,tvars),name="update_batch")
